    ...
    fun atualizarAprovacoesViaCsv(inputStream: InputStream) {
        Scanner(inputStream).use { leitor ->
            ...
            while (leitor.hasNext()) {
                ...
                val orcamentoMin = leitor.next().replace(",", ".").toDouble()
    ...
    fun atualizarAprovacoesViaTxt(inputStream: InputStream) {
        Scanner(inputStream).use { leitor ->
            ...
            while (leitor.hasNext()) {
                ...
                val orcamentoMin = linha.substring(706,716).replace(",", ".").toDouble()
                val orcamentoMax = linha.substring(716,726).replace(",", ".").toDouble()
