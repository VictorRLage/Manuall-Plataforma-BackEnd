...
-- -----------------------------------------------------
-- Table `mydb`.`prospect_contratante_area`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`prospect_contratante_area` (
  `id` INT NOT NULL,
  `prospect_contratante_id` INT NOT NULL,
  `area_id` INT NOT NULL,
  PRIMARY KEY (`id`, `prospect_contratante_id`, `area_id`),
  INDEX `fk_prospect_contratante_has_area_area1_idx` (`area_id` ASC) VISIBLE,
  INDEX `fk_prospect_contratante_has_area_prospect_contratante1_idx` (`prospect_contratante_id` ASC) VISIBLE,
  CONSTRAINT `fk_prospect_contratante_has_area_prospect_contratante1`
    FOREIGN KEY (`prospect_contratante_id`)
    REFERENCES `mydb`.`prospect_contratante` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
