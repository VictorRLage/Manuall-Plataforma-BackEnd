...
('Mariana Oliveira', 'mariana.oliveira@example.com', '$2a$10$GLZUkiDGCqZG9LX7YC/tRuPVBCNtaEhDlf.KvYtiSI7TkQ41.0zNu', '67890123456', '11956789012', 1200.00, 2000.00, 'Especialista em Biologia', 0, 1, 2, 'https://source.unsplash.com/random/800x600', 0, 2, 1, 5),
...
(1, 2, 3, "Serviço dentro das expectativas"),
(1, 3, 4, "Ótimo atendimento, recomendo"),
(1, 4, 2, "Insatisfatório, poderia ter sido melhor"),
(1, 5, 1, "Decepcionante, não recomendo"),
(1, 6, 5, "Maravilhoso! Superou todas as expectativas"),
(1, 1, 4, "Bom serviço, com pequenos problemas"),
(1, 3, 0, "Horrível! Nunca mais contratarei"),
(1, 4, 3, "Médio, nem bom nem ruim"),
(1, 5, 2, "Serviço ruim, poderia ser melhor"),
(1, 6, 5, "Serviço excepcional, superou minhas expectativas"),
(1, 1, 2, "Apenas ok, esperava mais"),
(1, 2, 4, "Serviço acima da média, mas com pequenos problemas"),
(1, 4, 5, "Excelente serviço, recomendo"),
...
(1, 3, 5, "Ótimo atendimento, recomendo"),
(1, 5, 4, "Bom atendimento, com algumas ressalvas"),
(1, 6, 1, "Fiquei muito desapontado, esperava mais"),
(1, 1, 3, "Aceitável, dentro do esperado"),
(1, 2, 4, "Bom serviço, dentro das expectativas"),
(1, 3, 2, "Insatisfatório, poderia ter sido melhor"),
(1, 4, 1, "Decepcionante, não voltarei a contratar"),
(1, 6, 5, "Serviço excelente, superou minhas expectativas"),
(1, 1, 1, "Serviço abaixo das expectativas"),
(1, 2, 5, "Sensacional! Serviço impecável"),
(1, 3, 4, "Bom serviço, com pequenos problemas"),
(1, 4, 0, "Muito insatisfeito, não cumpriu o combinado"),
(1, 5, 3, "Médio, nem bom nem ruim"),
(1, 1, 5, "Excelente serviço, recomendo"),
(1, 2, 0, "Péssimo serviço, não recomendo"),
(1, 3, 3, "Serviço satisfatório, mas com algumas falhas"),
(1, 4, 2, "Simplesmente ok, nada demais"),
(1, 5, 1, "Péssimo atendimento, não recomendo"),
(1, 6, 4, "Bom serviço, dentro das expectativas"),
(1, 2, 4, "Muito bom o serviço, mas demorou mais que o esperado"),
(1, 3, 2, "Serviço ruim, poderia ser melhor"),
(1, 4, 1, "Decepcionante, não voltarei a contratar"),
(1, 5, 5, "Ótimo atendimento, recomendo"),
(1, 6, 3, "Serviço aceitável, mas nada demais"),
(1, 1, 0, "Péssimo serviço, não recomendo"),
(1, 2, 3, "Atendeu às expectativas mínimas"),
(1, 3, 5, "Ótimo atendimento, recomendo"),
(1, 4, 4, "Bom atendimento, com algumas ressalvas"),
