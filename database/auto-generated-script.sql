...
CREATE TABLE IF NOT EXISTS `mydb`.`area_usuario` (
  ...
  PRIMARY KEY (`id`, `fk_usuario`, `fk_area`),
  INDEX `fk_Usuario_has_Area_Area1_idx` (`fk_area` ASC) VISIBLE,
  INDEX `fk_Usuario_has_Area_Usuario1_idx` (`fk_usuario` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`anexo` (
  ...
  `usuario_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_Anexo_Chat1_idx` (`usuario_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `mydb`.`ProspectContratante`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`ProspectContratante` (
